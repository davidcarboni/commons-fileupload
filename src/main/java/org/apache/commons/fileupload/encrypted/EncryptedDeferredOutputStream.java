...
public class EncryptedDeferredOutputStream
    ...
    /**
     * The encryption key to use for this stream.
     */
    ...
    public EncryptedDeferredOutputStream(int threshold, String prefix, String suffix, File directory, SecretKey key) {
        this(threshold, null, prefix, suffix, directory, key);
        if (prefix == null) {
    ...
    protected void thresholdReached() throws IOException {
        ...
        OutputStream fos = Cryptography.encrypt(new FileOutputStream(outputFile), key);
    ...
    public void writeTo(OutputStream out) throws IOException {
        ...
        if (isInMemory()) {
            ...
            InputStream fis = Cryptography.decrypt(new FileInputStream(outputFile), key);
            try {
